...
const ColorTab: React.FC<ColorTabProps> = ({ qrSettings, onSettingsChange }) => {
  ...
  const ColorFrame = ({ 
    ...
    return (
      <fieldset className="border border-gray-200 rounded-xl p-2 shadow-sm">
    ...
    <div className="space-y-6">
      ...
      <div className="border-gray-200 space-y-2 text-center">
            <button
              ...
              className="px-3 py-2 text-sm bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-left mr-2"
            >
              Reset to Classic
            </button>
            <button
