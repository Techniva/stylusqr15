    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Frame Style</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Frame Text</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Frame Colors</h3>
        </div>
