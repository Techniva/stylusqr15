            ...
            {user ? (
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                    <ul className="py-1">
                      <li>
                        <a
                          href="/dashboard"
                          className="w-full block px-4 py-2 flex items-center gap-2 rounded-lg transition-colors hover:bg-gray-100 text-gray-700"
              ...
              <>
                <button 
                  ...
                  className="text-[#063970] hover:text-[#052c5c] px-4 py-2 rounded-lg border border-[#063970] hover:bg-[#063970]/5 transition-colors text-sm font-medium"
                >
                  Login
                </button>
                <button 
                  onClick={() => openAuthModal("register")}
                  className="bg-[#063970] text-white px-4 py-2 rounded-lg hover:bg-[#052c5c] transition-colors text-sm font-medium"
                >
                  Register
                </button>
              </>
